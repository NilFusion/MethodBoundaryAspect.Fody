...
namespace MethodBoundaryAspect.Fody.UnitTests.Net461.TestAssembly
{
    public class OverwriteReturnValues
    {
        ...
        [Shared.TestAssemblyAspects.OverwriteReturnValueAspect("Overwritten")]
        ...
        [Shared.TestAssemblyAspects.OverwriteReturnValueAspect(42)]
        int ExternReturnInt()
        {
            return -1;
        }
        ...
        [Shared.TestAssemblyAspects.OverwriteReturnValueAspect(TestValues.Overwritten)]
        ...
        [Shared.TestAssemblyAspects.OverwriteReturnValueAspect("not an integer")]
        ...
        [Shared.TestAssemblyAspects.OverwriteReturnValueAspect(new string[] { "one", "two" })]
